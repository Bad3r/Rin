...
export class AppError extends Error {
  ...
  constructor(code: ErrorCode, message: string, statusCode: number, details?: ErrorDetail[], isOperational = true) {
    super(message)
...
export class ExternalServiceError extends AppError {
  constructor(service: string, message?: string) {
    super('EXTERNAL_SERVICE_ERROR', message || `Error connecting to ${service}`, 500, undefined, false)
  }
}
