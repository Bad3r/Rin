...
export class TestAPIClient {
  ...
  feed = {
    ...
    create: async (body: CreateFeedRequest, options?: TestAPIOptions): Promise<ApiResponse<{ insertedId: number }>> => {
      return this.post<{ insertedId: number }>('/feed', body, options)
    },

    update: async (id: number, body: UpdateFeedRequest, options?: TestAPIOptions): Promise<ApiResponse<void>> => {
    ...
    setTop: async (id: number, top: number, options?: TestAPIOptions): Promise<ApiResponse<void>> => {
  ...
  auth = {
    ...
    login: async (body: LoginRequest, options?: TestAPIOptions): Promise<ApiResponse<LoginResponse>> => {
  ...
  friend = {
    ...
    create: async (body: CreateFriendRequest, options?: TestAPIOptions): Promise<ApiResponse<Friend>> => {
      return this.post<Friend>('/friend', body, options)
    },

    update: async (id: number, body: UpdateFriendRequest, options?: TestAPIOptions): Promise<ApiResponse<Friend>> => {
  ...
  moments = {
    ...
    create: async (body: CreateMomentRequest, options?: TestAPIOptions): Promise<ApiResponse<Moment>> => {
      return this.post<Moment>('/moments', body, options)
    },

    update: async (id: number, body: CreateMomentRequest, options?: TestAPIOptions): Promise<ApiResponse<Moment>> => {
  ...
  // Storage API
  storage = {
    upload: async (file: File, key?: string, options?: TestAPIOptions): Promise<ApiResponse<UploadResponse>> => {
  ...
  wp = {
    import: async (xmlContent: string, options?: TestAPIOptions): Promise<ApiResponse<{ imported: number }>> => {
