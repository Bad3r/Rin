...
export function Menu({ profile }: { profile?: Profile | null }) {
  ...
  return (
    <div className='visible md:hidden flex flex-row items-center'>
      ...
      >
        <div
          className={`mt-4 flex w-[50vw] flex-col rounded-2xl border border-black/10 bg-white p-2 shadow-lg shadow-black/5 dark:border-white/10 dark:bg-dark dark:shadow-black/20`}
        >
