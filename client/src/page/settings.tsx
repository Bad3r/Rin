    ...
    <div className='flex flex-col w-full items-start'>
      ...
      >
        <div className='flex flex-col items-start p-4 bg-w space-y-4 w-full'>
          <h1 className='text-2xl font-bold t-primary'>{t('update$sth', { sth: configKeyTitle })}</h1>
          <textarea
  ...
  return (
    <>
      ...
      <div className='flex flex-col w-full items-start'>
        <div className='flex flex-row justify-between w-full items-center'>
          <div className='flex flex-col'>
            <p className='text-lg font-bold dark:text-white'>{t('settings.ai_summary.enable.title')}</p>
            <p className='text-xs text-neutral-500'>{t('settings.ai_summary.enable.desc')}</p>
          </div>
          <div className='flex flex-row items-center justify-center space-x-4'>
            {loading && <ReactLoading width='1em' height='1em' type='spin' color='#FC466B' />}
      ...
      {enabled && (
        <>
          ...
          <div className='flex flex-col w-full items-start'>
            <div className='flex flex-row justify-between w-full items-center'>
              <div className='flex flex-col'>
                <p className='text-lg font-bold dark:text-white'>{t('settings.ai_summary.provider.title')}</p>
                <p className='text-xs text-neutral-500'>{t('settings.ai_summary.provider.desc')}</p>
              </div>
              <div className='flex flex-row items-center space-x-2'>
                <select
                  value={provider}
          ...
          <div className='flex flex-col w-full items-start'>
            <div className='flex flex-row justify-between w-full items-center'>
              <div className='flex flex-col'>
                <p className='text-lg font-bold dark:text-white'>{t('settings.ai_summary.model.title')}</p>
                <p className='text-xs text-neutral-500'>{t('settings.ai_summary.model.desc')}</p>
              </div>
              <div className='flex flex-row items-center space-x-2'>
                <input
                  list='model-options'
            ...
            <div className='flex flex-row justify-between w-full items-center'>
              <div className='flex flex-col'>
                <p className='text-lg font-bold dark:text-white'>
                  ...
                  {apiKeySet && (
                    <span className='ml-2 text-xs text-green-500'>(✓ {t('settings.ai_summary.api_key.set')})</span>
                  )}
                </p>
                <p className='text-xs text-neutral-500'>{t('settings.ai_summary.api_key.desc')}</p>
              </div>
              <div className='flex flex-row items-center space-x-2'>
                <input
                  type='password'
          ...
          <div className='flex flex-col w-full items-start'>
            <div className='flex flex-row justify-between w-full items-center'>
              <div className='flex flex-col'>
                <p className='text-lg font-bold dark:text-white'>{t('settings.ai_summary.api_url.title')}</p>
                <p className='text-xs text-neutral-500'>{t('settings.ai_summary.api_url.desc')}</p>
              </div>
              <div className='flex flex-row items-center space-x-2'>
                <input
                  type='text'
      ...
      {enabled && (
        <div className='flex flex-col w-full items-start'>
          <div className='flex flex-row justify-between w-full items-center'>
            <div className='flex flex-col'>
              <p className='text-lg font-bold dark:text-white'>{t('settings.ai_summary.test.title')}</p>
              <p className='text-xs text-neutral-500'>{t('settings.ai_summary.test.desc')}</p>
            </div>
            <div className='flex flex-row items-center space-x-2'>
          ...
          {testStatus === 'success' && testResult && (
            <div className='mt-2 p-3 bg-green-100 dark:bg-green-900 rounded-lg w-full'>
              ...
              <p className='text-xs text-green-700 dark:text-green-300 mt-1'>{testResult.response}</p>
            </div>
          )}
          {testStatus === 'error' && testResult && (
            <div className='mt-2 p-3 bg-red-100 dark:bg-red-900 rounded-lg w-full'>
              ...
              {testResult.error && (
                <p className='text-xs text-red-700 dark:text-red-300 mt-1 font-medium'>{testResult.error}</p>
              )}
              {testResult.details && (
                <p className='text-xs text-red-600 dark:text-red-400 mt-1'>{testResult.details}</p>
              )}
              {!testResult.error && !testResult.details && (
                <p className='text-xs text-red-700 dark:text-red-300 mt-1'>{JSON.stringify(testResult)}</p>
              )}
            </div>
          )}
        </div>
      ...
      {hasUnsavedChanges && (
        <div className='flex flex-col w-full items-start'>
          <div className='flex flex-row justify-between w-full items-center'>
            <div className='flex flex-col'>
              <p className='text-lg font-bold dark:text-white'>{t('settings.ai_summary.save.title')}</p>
              <p className='text-xs text-neutral-500'>{t('settings.ai_summary.save.desc')}</p>
            </div>
            <div className='flex flex-row items-center space-x-2'>
              {loading && <ReactLoading width='1em' height='1em' type='spin' color='#FC466B' />}
              <Button title={t('settings.ai_summary.save.button')} onClick={handleSaveConfig} disabled={loading} />
            </div>
          </div>
          <p className='text-xs text-yellow-500 mt-1'>{t('settings.ai_summary.unsaved_changes')}</p>
        </div>
      )}
      <AlertUI />
    </>
