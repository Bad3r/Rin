...
1. Visit the [Rin GitHub Repository](https://github.com/Bad3r/Rin)
...
1. Click **"Sync branch"** on your repository page
...
> Current deployment remains `Worker + Assets`. Future split to `Pages + Worker` is tracked in [issue #14](https://github.com/Bad3r/Rin/issues/14).
